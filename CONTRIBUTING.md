...
This project adheres to a [Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior via [GitHub Issues](https://github.com/dipockdas/keysync/issues/new) (note that the report concerns the Code of Conduct in the issue title).
...
3. **Run tests and security checks**
   ...
   CI also runs [govulncheck and Gitleaks](docs/SECURITY-SCANNING.md) on every PR.
