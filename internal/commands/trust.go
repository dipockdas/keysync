...
func newTrustCmd() *cobra.Command {
	return &cobra.Command{
		...
		Long: F(`Updates macOS keychain partition lists so the current keysync binary can read
secrets without repeated password prompts. Does not read or print secret values.
